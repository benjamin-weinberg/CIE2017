  ...
  while (userNumber != -1) /* while the user is not done */
    {
      ...
      /* if the randomly generated number and the user number are
         ...
         print "DIFFERENT" */
	//if the number is the same print SAME
	if (userNumber == randomNumber)
	{
		cout << "SAME" << endl;
	}
	//if different then display DIFFERENT
	else if (userNumber != -1) 
	{
		cout << "DIFFERENT" << endl;
	}
	//if the user entered -1 do nothing
	else
	{
		//The user entered -1 and wants to quit, so do nothing
	}
    }
